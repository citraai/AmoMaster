            ...
            <header className="sticky top-0 z-50 glass border-b border-white/5">
                <div className="max-w-lg mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-white font-bold text-lg">⚡ 爆速記録</h1>
            ...
            <div className="max-w-lg mx-auto px-4 py-3">
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder="記録を検索..."
                        className="w-full bg-white/5 border border-white/10 rounded-xl pl-11 pr-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-yellow-500/50"
                    />
                    {searchQuery && (
                        <button
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <div className="flex gap-1.5 overflow-x-auto hide-scrollbar">
                        ...
                        <input
                            ...
                            className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all bg-white/5 text-white/50 hover:bg-white/10 ${dateFilter === "custom" ? "border border-yellow-500/50" : ""
                                }`}
                        />
                    </div>
                </div>
                        ...
                        {filteredRecords.map((record) => {
                            ...
                            return (
                                <button
                                    ...
                                    className="w-full text-left glass rounded-xl p-4 border border-white/5 hover:border-yellow-500/30 transition-colors"
                                >
